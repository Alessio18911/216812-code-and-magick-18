...
window.GameConstants = {
  Fireball: {
    size: window.wizardConstants.fireballSize || 24,
    speed: window.wizardConstants.getFireballSpeed || function (movingLeft) {
      return movingLeft ? 2 : 5;
    }
  },
  Wizard: {
    speed: window.wizardConstants.wizardSpeed || 2,
    width: window.wizardConstants.wizardWidth || 61,
    getHeight: window.wizardConstants.getWizardHeight || function (width) {
      return 1.377 * width;
    },
    getX: window.wizardConstants.getWizardX || function (width) {
      return width / 3;
    },
    getY: window.wizardConstants.getWizardY || function (height) {
      return height - 100;
    }
  }
};
